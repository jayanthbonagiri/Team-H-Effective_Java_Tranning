...
//	}
	...
	public boolean transfer(int accountNumber,int accountfrom,double amount,String password,int accountto) {
		...
		if(accountfrom==getAccountNumber())
			if(accountto==getAccountNumber()) {
